...
Jose Delgado:
  ...
  -Individual:
    ...
    Uso de la correlacion cramer para responder a ¿Existe una correlación significativa entre las variables categóricas            y la variable objetivo "is_promoted"?
...
Segunda pregunta individual:
    ...
    Uso de la correlación cramer para responder a ¿Existe una correlación significativa entre las variables categórica del         dataset y la variable objetivo "is_promoted"?
